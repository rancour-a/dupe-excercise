...
// https://www.programcreek.com/java-api-examples/?code=gentoku/name-matcher/name-matcher-master/src/namematcher/MatcherLevenshtein.java#
...
//		String b = "Manchester Citey";
//		MatcherLevenshtein ml = new MatcherLevenshtein(3);
//		System.out.println(ml.getLevenshteinDistance(a, b) + " for " + a + ", " + b);
//		System.out.println(ml.match(a,b));
//	}
}